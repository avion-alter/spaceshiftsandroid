 ...
 */
public class OfficeListAdapter extends RecyclerView.Adapter<OfficeListAdapter.RoleViewHolder> {
    ...
    public RoleViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        views = LayoutInflater.from(parent.getContext()).inflate(R.layout.row_office_list, parent, false);
